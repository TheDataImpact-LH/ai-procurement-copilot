...
> Conversational AI that answers procurement questions using RAG + Claude API. Ask *"Which supplier missed SLAs in Q3?"* and get cited, data-grounded answers in seconds.
